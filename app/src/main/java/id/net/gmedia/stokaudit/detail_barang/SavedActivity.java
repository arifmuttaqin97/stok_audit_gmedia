...
import id.net.gmedia.stokaudit.list_barang.MasterBarangActivity;
            ...
            public void onResponse(@NonNull Call<ApiResponse> call, @NonNull Response<ApiResponse> response) {
                ...
                if (response.body() != null) {
                    if (Objects.equals(response.body().getMetadata().get("status"), "200")) {
                        ...
                        Toast.makeText(SavedActivity.this, response.body().getMetadata().get("message"), Toast.LENGTH_SHORT).show();
